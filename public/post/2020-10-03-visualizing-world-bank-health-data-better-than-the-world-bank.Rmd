...
One of my SMU professors, William Bowser, kindly collected the raw data and you can download it here.  This contains expenditures in U.S dollars rather than percent form, but that matters not since the content is the same.  

We'll need to quite a bit of data cleaning as the format for data entry isn't optimal for data analysis and visualization.  The complete code for cleaning and plotting the data is provided below, but I won't spend my time discussing the cleaning portion.  I'd rather focus on the comparing the original WHO viz and mine.
