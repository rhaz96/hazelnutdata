...
All along we worked with gradient *ascent*.  It's quite simple to write out the update rule for gradient *descent*.  We simply switch the order of the terms in the bracket.  In other words,
