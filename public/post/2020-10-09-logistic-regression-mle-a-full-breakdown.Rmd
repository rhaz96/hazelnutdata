...
The above result accords with Sebastian Raschka's [derivation](http://rasbt.github.io/mlxtend/user_guide/classifier/LogisticRegression/) as well, the only difference being I use $m$ denote the number of instances rather than $n$.  This reflects standard matrix notation, which is usually denoted as $m \times n$ with $m$ denoting the number of rows (instances) and $n$ representing the number of features/predictors, just like $Aur\acute{e}lien\,G\acute{e}ron$ uses in Chapter 4 of his [book](https://www.amazon.com/Hands-Machine-Learning-Scikit-Learn-TensorFlow/dp/1492032646/ref=pd_lpo_14_t_0/137-1558474-5920363?_encoding=UTF8&pd_rd_i=1492032646&pd_rd_r=6de24cf5-2761-40bf-adb1-fa3b9bfcd422&pd_rd_w=sk3DP&pd_rd_wg=xloDV&pf_rd_p=7b36d496-f366-4631-94d3-61b87b52511b&pf_rd_r=GDSE8Y5KGDRPZ1T96EXY&psc=1&refRID=GDSE8Y5KGDRPZ1T96EXY).  I used $p$ instead of $n$, which is a hat-tip to the statistics community.
