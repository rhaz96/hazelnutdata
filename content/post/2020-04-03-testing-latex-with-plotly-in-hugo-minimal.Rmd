---
title: Testing LaTeX with Plotly in Hugo Minimal
author: Robert Hazell
date: '2020-04-03'
slug: testing-latex-with-plotly-in-hugo-minimal
categories: []
tags:
  - out-of-the-loop
description: ''
...
So I don't know why LaTeX code renders natively without modifying Minimal's Javascript, or why it it *doesn't* render when I include plotly chart.  Thankfully, you can turn to CodeCogs to sort it out!  