...
Now, just because linear regression models are interpretable doesn't mean it can't become complex. Complexity often arises from combining use of interaction terms and logarithmic transforms.  In the appetizer, interaction terms allow the slope of each neighborhood's selling price to differ.
