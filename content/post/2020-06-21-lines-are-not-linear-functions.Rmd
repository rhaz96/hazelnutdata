...
whera $\alpha$ and $\beta$ are both scalar constants.  MIT [provides the definition](http://www-math.mit.edu/~djk/calculus_beginners/chapter03/section03.html) albeit with slightly different notation.  
