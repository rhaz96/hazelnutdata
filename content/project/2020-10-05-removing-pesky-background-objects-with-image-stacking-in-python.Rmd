...
The original images in Figure 1 can be downloaded below.

```{r echo=F}
xfun::embed_file("~/Desktop/SMU/ImpracticalPython/toy_train/train_pics.zip")
```
...
### Part 4: Getting the median pixel densities for the stacked image
